...
export default function AuthForm() {
  ...
  return (
    <div className="auth-box bg-info english-auth">
      <Header />
          ...
          >
            ...
            {isRegister && (
              <Form.Group className="mb-3" controlId="name">
                <Form.Control
                  className="w-100 p-2 p-md-3 rounded bg-info outline-none text-start"
                  type="text"
                  placeholder="Name"
                  minLength="2"
                  required
            ...
            <Form.Group className="mb-3" controlId="email">
              <Form.Control
                className="w-100 p-2 p-md-3 rounded bg-info text-start"
                type="email"
